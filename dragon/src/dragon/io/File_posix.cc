...
static Logger* logger = Logger::getLogger("dragon::io::File#posix", DEBUG);
...
bool File::isDirectory() {
    ...
    Array<char> utf8Path = this->path->getBytes("UTF-8");
    result = stat64(utf8Path.raw(), &stat);
...
bool File::canWrite() {
    ...
    return ((stat.st_mode & S_IWRITE) != 0);
}
