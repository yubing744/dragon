...
#include <dragonx/imageio/plugins/jpeg/JPEGImageReader.h>

Import dragon::io;
Import dragonx::imageio::plugins::jpeg;
...
BufferedImage* JPEGImageReader::read(InputStream* input) throw(IOException*) {
    ...
    BufferedImage* image = new BufferedImage(cinfo.output_width, cinfo.output_height, ColorModel::RGB);
