...
#ifndef PNGImageWriter_Png_Plugins_Io_Image_Dragonx_H
#define PNGImageWriter_Png_Plugins_Io_Image_Dragonx_H
...
class_ PNGImageWriter extends(AbstractImageWriter) {
public:
...
#endif //PNGImageWriter_Png_Plugins_Io_Image_Dragonx_H
