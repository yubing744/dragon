...
#ifndef TGAImageReader_Tga_Plugins_Io_Image_Dragonx_H
#define TGAImageReader_Tga_Plugins_Io_Image_Dragonx_H
...
class_ TGAImageReader extends(AbstractImageReader) {
public:
...
#endif //TGAImageReader_Tga_Plugins_Io_Image_Dragonx_H
