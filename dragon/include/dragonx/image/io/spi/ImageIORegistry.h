...
#ifndef ImageIORegistry_Spi_Image_IO_Dragonx_H
#define ImageIORegistry_Spi_Image_IO_Dragonx_H
...
BeginPackage4(dragonx, image, io, spi)
...
EndPackage4 //(dragonx, image, io, spi)

#endif //ImageIORegistry_Spi_Image_IO_Dragonx_H
