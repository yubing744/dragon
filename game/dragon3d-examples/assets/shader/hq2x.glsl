...
void main()
{
    ...
    _TMP8.VARc01 = TexCoord.xy + vec2(-_delta.x, 0.00000000E+00);
    _TMP8.VARc02 = TexCoord.xy + vec2(-_delta.x, _delta.y);
    _TMP8.VARc10 = TexCoord.xy + vec2(0.00000000E+00, -_delta.y);
    _TMP8.VARc12 = TexCoord.xy + vec2(0.00000000E+00, _delta.y);
    _TMP8.VARc20 = TexCoord.xy + vec2(_delta.x, -_delta.y);
    _TMP8.VARc21 = TexCoord.xy + vec2(_delta.x, 0.00000000E+00);
