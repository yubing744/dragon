...
const Type* ShaderException::TYPE = TypeOf<ShaderException>();
static Logger* logger = Logger::getLogger(ShaderException::TYPE, ERROR);
...
ShaderException::ShaderException(const String& msg, Throwable* cause) 
    :Exception(msg, cause) {
